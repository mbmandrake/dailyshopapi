...
async function getListaUsuario(){
    ...
    let result = await pool.request().query(
        'SELECT ID_USUARIO AS ID, TX_NOME AS NOME, TX_EMAIL AS EMAIL, TX_SENHA AS SENHA, TX_TELEFONE AS TELEFONE, TX_CPF AS CPF, ID_ENDERECO AS ENDERECO, ID_GRUPO AS GRUPO, BL_ATIVO AS STATUS, DT_REGISTRO from USUARIO where BL_ATIVO = 1;'
    );
